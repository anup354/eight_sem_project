...
const index = () => {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ value }) => {
          ...
          const strippedText = removeTags(value);
          ...
          const previewText = getPreview(strippedText);
      ...
      },
      {
        ...
        Cell: ({ row }: any) => (
          <div className="flex justify-center">
            <Image
              src={row?.original?.blog_image}
              width={50}
              height={50}
              alt={row?.original?.blog_image}
            ></Image>
          </div>
        ),
      },
  ...
  return (
    <>
      {renderapp && (
        <div className="container-fluid bg-light ml-5  mb-10 max-h-[500vh]   ">
          <Head>
            <title>Blog | Prediction</title>
          </Head>
          <div className="container pt-5  " style={{}}>
            <div className="flex justify-between">
              ...
              <Link href="/admin/blog/add">
                <div className="bg-purple-900 border border-purple-900 text-white rounded py-2 px-3 hover:bg-transparent hover:text-purple-900">
                  Add
                </div>
              </Link>
            </div>
