        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          ...
          <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
            <ul className="space-y-4 text-gray-600">
              <h4 className="text-gray-800 font-semibold sm:pb-2">Resources</h4>
            ...
            <ul className="space-y-4 text-gray-600">
              <h4 className="text-gray-800 font-semibold sm:pb-2">About</h4>
            ...
            <ul className="space-y-4 text-gray-600">
              <h4 className="text-gray-800 font-semibold sm:pb-2">Explore</h4>
            ...
            <ul className="space-y-4 text-gray-600">
              <h4 className="text-gray-800 font-semibold sm:pb-2">Company</h4>
