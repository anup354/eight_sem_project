...
const index = () => {
  ...
  const handleEditClick = async (e, slug) => {
    e.preventDefault();
    router.push(`/admin/bank/edit/${slug}`);
              ...
              <div className="relative ">
                ...
                {isOpen && (
                  ...
                  >
                    <div
                      onClick={(e) =>
                        handleEditClick(e, row.original.bank_id)
                      }
                      ...
                      onClick={() =>
                        Swal.fire({
                          ...
                          if (result.isConfirmed) {
                            handleDeleteClick(row.original.bank_id);
                          }
                        })
                      }
                      className=""
          ...
          <div className="container pt-5  " style={{}}>
            <div className="flex justify-between">
              <div className="grid grid-cols-2 text-black">
                <div className="text-xl ">Banks</div>
              </div>
